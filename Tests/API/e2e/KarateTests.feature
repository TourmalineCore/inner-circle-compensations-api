...
Feature: Test Flow
    ...
    Scenario: Test flow
        ...
        * def accessToken = karate.toMap(response.accessToken.value)
        ...
        And request { 'compensations': [ { 'typeId': 1, 'comment': 'test - I bought milk', 'amount': 760 }, { 'typeId': 2, 'comment': 'test - I bought this', 'amount': 2760.45 } ], 'CompensationRequestedForYearAndMonth': '2023-12-01T00:00:00Z', "employeeId": 2 }
        When method POST
        Then status 200
